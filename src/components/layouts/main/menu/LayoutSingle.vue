<template>
  <div class="body_layer">
    <div class="title_container" v-if="titleFlag === ''">
      ...
      <button type="button" class="btn_title" @click="fnCallRouter('mainMulti')">
        <h1>멀티플레이</h1>
        <h4>시즌별로 진행하는 멀티플레이입니다.</h4>
      </button>
      <button type="button" class="btn_title" @click="fnCallRouter('mainData')">
        <h1>데이터</h1>
        <h4>게임의 데이터 정보입니다.</h4>
      </button>
      <button type="button" class="btn_title" @click="fnCallRouter('mainUserData')">
        <h1>사용자 정보</h1>
...
<style lang="scss" scoped>
  @import "@/components/main/LayoutMenu.scss"
</style>