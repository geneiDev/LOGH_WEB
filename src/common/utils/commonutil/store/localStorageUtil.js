...
import cipherUtil from '@/common/utils/commonutil/store/cipherUtil'
import isJsonString from '@/common/utils/commonutil/store/isJsonString'
...
const localStorageUtil = {
  ...
  //   const filterArray = searchWords.filter(value => {
  //     return value.keyword !== keyword
  //   }) || []

  //   this.handleExceedingMaxCnt(filterArray, maxCnt)

  //   filterArray.push(searchWord)

  //   this.set(name, filterArray)
  // },
  // /**
  //  * 검색어 중복 여부 반환
