...
export const scenarioMeta = [
  {
    ...
    preview : [
      ...
      '새로운 발명과 발견은 명맥이 끊겼고, 민주주의는 자정능력을 잃어 중우정치로 타락하고, 변경 성역 개발 계획은 폐기되었으며, 식민지는 버려졌다.',
      '사회와 문화는 퇴폐 일로를 걸었고, 사람들은 타락하여 마약, 폭력에 빠져들었으며, 범죄율은 나날이 증가했고 검거율은 줄어들었으며 사람들은 도덕을 비웃고 생명을 경시했다.',
      '이렇게 연방은 서서히 썩어들어가고 있었다.',
      '마치 질식할 것만 같은 사회 분위기에 지쳐가던 사람들은 모든 사회문제를 통쾌하게 해결하고 자신들이 힘겹게 지고 있던 고통을 대신 떠안아줄 \'영웅\'의 등장을 갈망하게 되었다.',
      '그리고 우주력 296년. 해적들이 들끓던 베텔기우스 지역을 평정한 \'영웅\'이 등장한다.'
    ],
    previewImg : [
      'assets/images/common/event/scenario/GalacticFederation.webp',
      'assets/images/common/event/scenario/PlvsVltra.webp',
      'assets/images/common/event/scenario/GalacticFederation.webp',
      'assets/images/common/event/scenario/GalacticFederation.webp',
      'assets/images/common/event/scenario/GalacticFederation.webp',
      'assets/images/common/event/scenario/GalacticFederation.webp',
