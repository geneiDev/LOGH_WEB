export const scenarioDetail1 = {
    ...
    preview : [
      ...
      '은하연방의 기치 아래 인류는 황금기를 누리며 인구, 과학, 문화를 기하급수적으로 발전시키고 더 먼 우주로 영토를 확장시킨다.',
    ...
    previewImg : [
      ...
      'images/event/scenario/01/GalacticFederationBig.png',
      'images/event/scenario/01/GalacticFederation.webp',
      'images/event/scenario/01/PlvsVltra.webp',
      'images/event/scenario/01/LowInderstry.webp',
      'images/event/scenario/01/LowPeople.png',
      '',
      '',
      '',
      '',
